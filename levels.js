...
const LEVELS = [
  // ───────── УРОВЕНЬ 1 — "Тест-арена" ──────────────────────────────────
  // Каждый тип врага в своей зоне для наблюдения. Слева направо:
  //   patrol (E) → guard (G) → runner (R) → flyer (F) → sniper (S) → bruiser (U) → boss (B)
  // Между зонами невысокие стенки для визуальной сепарации.
  [
    "                                                                                                                        ",
    "                                                                                                                        ",
    "                              F                                                                                         ",
